...
sed -i 's/force.https.host=/force.https.host='34.135.154.15'/g' framework/webapp/config/url.properties
sed -i 's/force.http.host=/force.http.host='34.135.154.15'/g' framework/webapp/config/url.properties
